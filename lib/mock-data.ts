...
export const agents: AgentNode[] = [
  ...
  },
  {
    id: "vaani",
    name: "VAANI",
    tag: "Multilingual citizen voice intake",
    group: "reactive",
    description: "Toll-free hotline. Any citizen calls in their own language — Whisper STT → Claude NER extracts location, need, urgency, vulnerable persons → DigiPIN-tagged → fed into MATCHMAKER. No app, no smartphone needed.",
    llmPowered: true,
    durationSec: 8,
    status: "complete",
    outputSummary: "1,247 calls received · 9 languages · 312 high-priority requests routed · 84% auto-classified",
  },
  {
    id: "capacity",
    name: "CAPACITY",
...
export const liveFeed: FeedEvent[] = [
  ...
  { ts: "T+00:02:16", agent: "VAANI", level: "info", message: "Toll-free 1078 surge · 4× normal call volume from Nagaon, Morigaon" },
  { ts: "T+00:02:18", agent: "VAANI", level: "ok", message: "নৰেন বৰাৰ ফোন · বাঢ়নি · ৩ বুঢ়া মানুহ আবদ্ধ · DigiPIN auto-tagged FK4-7M3-H8XW" },
  { ts: "T+00:02:19", agent: "VAANI", level: "info", message: "Whisper STT (অসমীয়া→en) · Claude NER · 9 entities extracted · routed to MATCHMAKER" },
